        ...
        <div>
          {state === false ?
            <>
              ...
              <Link href={'/home'}>  <div className={mode === false ? " flex items-center justify-center bg-black text-white h-12 rounded-lg w-96 mt-8" : " flex items-center justify-center bg-white text-black h-12 rounded-lg w-96 mt-8"}>
