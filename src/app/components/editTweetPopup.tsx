...
export const EditTweetPopup = () => {
 ...
 // Popup Transpart BG
     ...
     <textarea className=" mt-8 border border-solid border-[#CACACA] focus:outline-none rounded-2xl w-80 h-36 pt-3 pl-3 pr-3 font-PoppinsLight text-base" placeholder="There is no such thing as “Sad” You are either happy where you are OR You are furiously motivated to change something. either black or white. Yin and yang. ACT." ></textarea>
    <button onClick={()=>{ToggleShowTweetPopup()}} className=" bg-black text-white w-[112px] h-10 rounded-lg mt-6 font-SamsungSharpSansBold">Update</button>
    </div>
     </div>
       </div>
 </div>
