          ...
          <div onClick={handlePopupBackgroundClick} className=" bg-white rounded-3xl flex items-center justify-center" style={{ boxShadow: '0px 0px 5px rgba(0, 0, 0, 0.2)' }}>
            <div className="w-[400px] h-[350px]">
              ...
              <div className="w-full">
                <h3 className="text-black font-bold text-xl font-SamsungSharpSansBold text-center">Edit Tweet</h3>
                <hr className=" border border-[#CACACA] mt-2" />
                <div className=" flex flex-col items-center bg-white">
                  <textarea onChange={(e) => { editTweet(e.target.value) }} className=" mt-8 border border-solid border-[#CACACA] focus:outline-none rounded-2xl w-80 h-36 pt-3 pl-3 pr-3 font-PoppinsLight text-base" placeholder="There is no such thing as “Sad” You are either happy where you are OR You are furiously motivated to change something. either black or white. Yin and yang. ACT." ></textarea>
                  <button onClick={() => { ToggleShowTweetPopup(); updateTweet() }} className=" bg-black text-white w-[112px] h-10 rounded-lg mt-6 font-SamsungSharpSansBold">Update</button>
                </div>
              </div>
            </div>
          </div>
