 ...
 // Popup Transpart BG
     ...
     <div className=" flex items-center flex-col">
       ...
       <div className=" mt-9 mb-3 flex gap-12">
        ...
        <button onClick={() => { ToggleShowTweetPopup() }} className=" bg-black text-white w-[109px] h-10 rounded-lg font-SamsungSharpSansBold tracking-[.5px]">Delete</button>
      </div>
      </div>
     </div>
       </div>
