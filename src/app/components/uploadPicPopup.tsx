...
export const UploadPicPopup = () => {
    ...
    return (
        <>
         ...
         {galleryPopup === true ?
      // Popup Transpart BG
         <div onClick={() => { ToggleGalleyPopup() }} className=" bg-[#FFFFFF80] h-[100vh] w-full right-0 left-0 top-0 bottom-0 z-10 fixed flex items-center justify-center">
             {/* Popup Card */}
          ...
          <button onClick={()=>{ToggleGalleyPopup()}} className=" bg-black text-white w-[109px] h-10 rounded-lg mt-5 font-SamsungSharpSansBold">Post</button>
          </div>
          </div>
                </div>
      </div>
